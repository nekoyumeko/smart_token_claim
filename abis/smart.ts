export const smartAbi = [
  {
    inputs: [
      { internalType: "uint256", name: "_targetInterval", type: "uint256" },
      { internalType: "uint256", name: "_defaultAmount", type: "uint256" },
  ...
  { inputs: [], name: "MintCapExceeded", type: "error" },
  { inputs: [], name: "OnlyOneClaimPerWallet", type: "error" },
  { inputs: [], name: "PermitExpired", type: "error" },
  { inputs: [], name: "RIPBozo", type: "error" },
  { inputs: [], name: "TotalSupplyOverflow", type: "error" },
  { inputs: [], name: "WalletHasAlreadyClaimed", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
